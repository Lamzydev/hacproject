...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-ivory bg-gradient-to-r from-blue-100 to-blue-300">
      {/* Background */}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="display-heading text-5xl md:text-6xl lg:text-7xl text-ink"
            >
              {" "}
              Find Rare Deal{" "}
              <span className="italic text-cobalt-600">
                {" "}
                Through
              </span> <br /> Live Auctions.{" "}
            </motion.h1>
            ...
            >
              ...
              art — bid, buy, and connect with the continent's foremost
              creators.
            </motion.p>
